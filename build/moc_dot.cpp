...
**
** Created: Sun Jul 22 19:29:49 2012
...
static const char qt_meta_stringdata_dot[] = {
    "dot\0move(int,int)\0x,y\0\0"
};

const QMetaObject dot::staticMetaObject = {
    { &QLabel::staticMetaObject, qt_meta_stringdata_dot,
      qt_meta_data_dot, 0 }
};
...
int dot::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: move((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        default: ;
        }
        _id -= 1;
    }
